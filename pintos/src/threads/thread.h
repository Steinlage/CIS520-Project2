...
struct thread {
  ...
  int64_t awake_time;         /* Time to awake (for awake sleeping thread) */
  struct list_elem sleepelem; /* List element for all sleep threads list. */
  ...
  // the status of this thread's exit
  int exit_status;
